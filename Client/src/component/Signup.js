...
const SigninForm = ({ theme }) => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      villOrTown: Yup.string().required("Required"),
      ph: Yup.string()
  ...
  return (
    <>
      <div className="mtext1">Welcome User</div>
          ...
          <form className="registration-form" onSubmit={formik.handleSubmit}>
            ...
            <div className="input-group">
              ...
              <input
                ...
                name="villOrTown"
                onChange={formik.handleChange}
                value={formik.values.villOrTown}
                placeholder="Village or Town"
                className={`underlined-input ${
                  formik.errors.villOrTown ? "error" : ""
                }`}
              />
              {formik.errors.villOrTown && (
                <div className="error-message">{formik.errors.villOrTown}</div>
              )}
            </div>
            <div className="input-group">
