...
router.get("/nurseacessmedicnetabel", authenticateTokens, medicineTbel); //// Nurse Medicine and disease
router.get("/symptable", authenticateTokens, symptreportneTbel); // Nurse Medicine and disease
